...
const FAQ = () => {
  ...
  return (
    <div className='FAQPage'>
      ...
      <p>&emsp;&emsp;&emsp;&emsp;<strong>Q: When are my Concur Expense Reports due?</strong><br/>
      &emsp;&emsp;&emsp;&emsp;A: </p><br />
        <img
      id="fpTimeline"
      src="../public/thumbs/FAQTimeline.jpg"
      alt="timeline"/>
      <br/><br/>
      <div className='faqInfo'>
        ...
        <p>
          ...
          <strong>Q: How do I handle client name, if using client address for mileage calculation and remain HIPAA compliant?</strong><br />
          A: For certain funding sources client name (or initials) are confidential and should not be entered into Concur or associated with an address. Please use "Confidential Client" in your business purpose or use the Client ID (no initials) if your program assigns them. You may also enter the miles manually, instead of using the map calculator or use a nearby intersection to double check your miles. Concur records and calculates whole miles, so you may round up if.<br /><br />
